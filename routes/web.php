...
Route::middleware(['auth', 'role:owner|admin'])->group(function () {
    ...
    Route::patch('/accounts/{user}/reactivate', [AccountController::class, 'reactivate'])
        ->name('accounts.reactivate');

    Route::patch('/accounts/{user}/archive', [AccountController::class, 'archive'])
        ->name('accounts.archive');

    Route::patch('/accounts/{user}/restore', [AccountController::class, 'restore'])
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::view('/user-manual', 'manual.index')->name('manual');
